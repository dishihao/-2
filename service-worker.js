const C='specimen-v9-admin-fix';
const A=['./','./index.html','./supabase-fetch-fix.js','./cloud-sync.js','./admin-permissions.js','./data-01.js','./data-02.js','./data-03.js','./data-04.js','./data-05.js','./data-06.js','./data-07.js','./data-08.js','./data-09.js','./data-10.js','./manifest.webmanifest','./icon.svg'];
